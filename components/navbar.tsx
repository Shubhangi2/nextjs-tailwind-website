            ...
            <div className="flex justify-between items-center px-4 md:px-7 h-[80px] border-[1px] border-gray-200">
                ...
                <div className="hidden md:flex items-center justify-between flex-1 ml-8">
                    <ul className="flex justify-start gap-4">
                        ...
                        <li><a href="/properties" className="hover:text-gray-600">Why Us?</a></li>
                    ...
                    <ul className="flex justify-start gap-6">
                        ...
                        <li><a href="/properties" className="hover:text-gray-600">Post Property</a></li>
            ...
            <div className={`md:hidden absolute w-full bg-white border-b-2 border-x-2 border-gray-200 transition-all duration-300 ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                ...
                <div className="px-4 py-4 space-y-4">
                    <ul className="space-y-2">
                        ...
                        <li><a href="/properties" className="block hover:text-gray-600">Why Us?</a></li>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><a href="/properties" className="block hover:text-gray-600">Post Property</a></li>
