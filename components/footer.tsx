        ...
        <footer className=" text-white w-full">
            <div className="text-[12px]  md:text-[15px]">
                <div className='w-full py-8  bg-gray-950'>
                    <div className=" max-w-[85%] mx-auto grid grid-cols-2 md:grid-cols-5 gap-8">

                        <div className="flex flex-col col-span-2 md:col-span-1 items-center md:items-start space-y-4">
                        ...
                        <div className="flex col-span-2 md:col-span-1 flex-col items-center md:items-start space-y-4">
                        ...
                        <div className="flex flex-col col-span-2 md:col-span-1 items-center space-y-4">
                ...
                <div className='w-full py-8 leading-8 bg-black'>
                    <div className=' max-w-[85%] mx-auto  flex flex-col xl:flex-row justify-between items-center'>
                        ...
                        <div>
                            ...
                            <p className='text-[13px] md:text-md'>All Rights Reserved. © 2025 PropertyPistol Pvt. Ltd.</p>
                        </div>
                    </div>
                </div>
            </div>
